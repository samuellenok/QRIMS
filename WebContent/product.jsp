		...
		<div class="navbar navbar-inverse navbar-fixed-top">
      		<div class="navbar-inner">
        		<div class="container">
            		...
            		<ul class="nav">
                    	<li class="add-menu"><a href="addNewProductdetails.jsp"><i class="icon-edit icon-white"></i> Add Product</a></li>
    ...
    <legend>Product Details</legend>
      <%if(request.getParameter("type")!=null){
        ...
        <ul class="thumbnails">
         <%while(rs.next()){ %>
        <li class="span3">
        	<a href="updateProductDetails.jsp?id=<%= rs.getString(1) %>"class="thumbnail plain">
     		<img src="http://chart.apis.google.com/chart?cht=qr&chl=<%= rs.getString(8) %>&chs=120x120" alt="" height="150" width="125">
    		<p align="center"><%= rs.getString(2) %><br>
    		<i class="icon-globe"></i> <%= rs.getString(4) %> <br>stock:<%= rs.getString(6) %></p>
			</a>
		</li>
		<%} %>
    	</ul>
    	...
    	<ul>
    	<li class="active">
    		<a href="#wines/page/1">1</a>
    	</li>
    	<li><a href="#wines/page/2">2</a></li><li><a href="#wines/page/3">3</a></li></ul></div></div></div>
    </div>
